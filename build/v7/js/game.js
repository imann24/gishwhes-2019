...
const minPlayAgainViewportX = 0.1;
const maxPlayAgainViewportX = 0.9;
...
let loadingScreenIsActive = true;;
...
function create()
{
    ...
    textPrompt = this.add.text(center.x - 200, center.y - 50, tapToJumpPrompt, {
        font: "50px BigJohn",
        fontStyle: "strong",
        fill: "#ff0044",
        stroke: "#000000",
    ...
    this.input.on("pointerdown", (pointer) => {
        if(loadingScreenIsActive || touchLock)
        {
            return;
        }
